...
my $HELP = '
        ...
        Usage:
               perl RNA_cfRNA-Seq_2.pl    [-version]    [-help]    [-in inputDir]    [-out outDir]
        For instance:
               nohup time  perl RNA_cfRNA-Seq_2.pl   -in 1_rawFASTQ   -out 2_removedAdapters    > RNA_cfRNA-Seq_2.runLog.txt  2>&1    &
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl RNA_cfRNA-Seq_2.pl  -help' \n";
    exit 0;
}
