...
my $HELP = '
        ...
        Usage:
               perl  RNA_cfRNA-Seq_1.pl    [-version]    [-help]     [-in inputDir]   
        For instance:
               nohup   time  perl  RNA_cfRNA-Seq_1.pl    -in 1_rawFASTQ   > RNA_cfRNA-Seq_1.runLog.txt  2>&1  & 
...
## Version Infromation
my $version = "    The 1st Step, version 1.1,  2023-03-05.";
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  RNA_cfRNA-Seq_1.pl  -help' \n";
    exit 0;
}
