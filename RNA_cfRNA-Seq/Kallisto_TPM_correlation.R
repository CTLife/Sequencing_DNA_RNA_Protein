...
###########################################################################################################################################################################
df_1 <- read.table("R23406090-library51-m6A.1.unstranded/abundance.tsv",  header=T,   sep="\t" )  
df_2 <- read.table("R23406091-library52-G3BP.1.unstranded/abundance.tsv",     header=T,   sep="\t" )  
df_3 <- read.table("R23406092-library53-SC35.1.unstranded/abundance.tsv",     header=T,   sep="\t" )  
df_4 <- read.table("R23407993-library60-S-R-1.1.unstranded/abundance.tsv",      header=T,   sep="\t" )  
df_5 <- read.table("R23407994-library61-S-R-2.1.unstranded/abundance.tsv",   header=T,   sep="\t" )  
...
matrix1 = log2( cbind( TPM_1, TPM_2, TPM_3, TPM_4, TPM_5   ) + 1)
matrix1[1:5, ]
