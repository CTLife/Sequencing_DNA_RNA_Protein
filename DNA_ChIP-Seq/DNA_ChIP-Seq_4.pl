...
my $HELP = '
        ...
        Usage:
               perl DNA_ChIP-Seq_4.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]  
        For instance:
               nohup time  perl DNA_ChIP-Seq_4.pl   -genome hg38   -in 3_removedDups   -out 4_rawBAM     > DNA_ChIP-Seq_4.runLog.txt  2>&1    &  
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  DNA_ChIP-Seq_4.pl  -help' \n";
    exit 0;
}
