...
my $HELP = '
        ...
        Usage:
               perl DNA_ChIRP-Seq_5.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]   
        For instance:
               nohup  time  perl DNA_ChIRP-Seq_5.pl   -genome hg38   -in 4_rawBAM/1_BWA   -out 5_finalBAM/1_BWA       > DNA_ChIRP-Seq_5.runLog 2>&1  &  
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  DNA_ChIRP-Seq_5.pl  -help' \n";
    exit 0;
}
