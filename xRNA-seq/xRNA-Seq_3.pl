...
my $HELP = '
        ...
        Usage:
               perl xRNA-Seq_3.pl    [-version]    [-help]    [-in inputDir]    [-out outDir]
        For instance:
               nohup  time   perl xRNA-Seq_3.pl   -in 2_removedAdapters   -out 3_removedDups    > xRNA-Seq_3.runLog.txt  2>&1     &      
...
## Version Infromation
my $version = "    The 3rd Step,  version 1.2,  2023-07-25. (Optional) ";
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl xRNA-Seq_3.pl  -help' \n";
    exit 0;
}
