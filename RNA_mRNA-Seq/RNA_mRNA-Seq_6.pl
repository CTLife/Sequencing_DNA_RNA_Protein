...
my $input_g    = '';  ## such as "5_rawBAM/3_STAR"
my $output_g   = '';  ## such as "6_finalBAM/3_STAR"
...
my $HELP = '
        ------------------------------------------------------------------------------------------------------------------------------------------------------
        ------------------------------------------------------------------------------------------------------------------------------------------------------
        Step 6: Only the mapped reads with MAPQ>20 are retained and reads on other chromosomes, all of them are removed. 
        ...
        Usage:
               perl RNA_mRNA-Seq_6.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]   
        For instance:
               nohup  time  perl RNA_mRNA-Seq_6.pl   -genome hg38   -in 5_rawBAM/3_STAR   -out 6_finalBAM/3_STAR       > RNA_mRNA-Seq_6.runLog 2>&1  &  
...
## Version Infromation
my $version = "    The 6th Step, version 1.1,  2023-03-05";
...
$input_g  = '5_rawBAM/3_STAR';           ## This is only an initialization value or suggesting value, not default value.
$output_g = '6_finalBAM/3_STAR';         ## This is only an initialization value or suggesting value, not default value.
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  RNA_mRNA-Seq_6.pl  -help' \n";
    exit 0;
}
...
my $target_fa = "";
if($genome_g eq "hg38") {$target_fa =  "/home/yongpeng/MyProgramFiles_02302023/14_Genomes/Gencode/Human_GRCh38.p13/gencode.v43.transcripts.fa"; }
if($genome_g eq "mm39") {$target_fa =  "/home/yongpeng/MyProgramFiles_02302023/14_Genomes/Gencode/Mouse_GRCm39/gencode.vM32.transcripts.fa" ; }
