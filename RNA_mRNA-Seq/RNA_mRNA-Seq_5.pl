...
my $HELP = '
        ...
        Usage:
               perl  RNA_mRNA-Seq_5.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]  [-mis mismatch] 
        For instance:
               nohup time  perl  RNA_mRNA-Seq_5.pl   -genome hg38   -in 3_removedDups   -out 5_rawBAM  -mis 0.05    > RNA_mRNA-Seq_5.runLog  2>&1  &
...
## Version Infromation
my $version = "   The 5th Step, version 1.1,  2023-03-05.";
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  RNA_mRNA-Seq_5.pl  -help' \n";
    exit 0;
}
...
for (my $i=0; $i<=$#pairedEnd_g; $i=$i+2) {
        ...
        system("hisat2         --threads $numCores_g   -q   --phred33       --rna-strandness RF      --sp 2,1      --trim5 1  --trim3 1    --summary-file    $HISAT2_4_g/3.R.$temp.summary    -x $HISAT2_index_g    -1 $input_g/$end1        -2 $input_g/$end2     -S $HISAT2_4_g/3.R.$temp.sam     >> $HISAT2_4_g/3.R.$temp.runLog  2>&1");
}
...
for (my $i=0; $i<=$#singleEnd_g; $i++) {
        ...
        $temp =~ s/\.gz//;
        $temp =~ s/\.bz2//;
        ##system("hisat2        --threads $numCores_g   -q   --phred33                             --sp 2,1      --trim5 1  --trim3 1  --summary-file  $HISAT2_4_g/1.un.$temp.summary   -x $HISAT2_index_g    -U $input_g/$singleEnd_g[$i]        -S $HISAT2_4_g/1.un.$temp.sam    >> $HISAT2_4_g/1.un.$temp.runLog  2>&1");
        ##system("hisat2        --threads $numCores_g   -q   --phred33        --rna-strandness F   --sp 2,1      --trim5 1  --trim3 1  --summary-file  $HISAT2_4_g/2.F.$temp.summary    -x $HISAT2_index_g    -U $input_g/$singleEnd_g[$i]        -S $HISAT2_4_g/2.F.$temp.sam     >> $HISAT2_4_g/2.F.$temp.runLog  2>&1");
        system("hisat2        --threads $numCores_g   -q   --phred33        --rna-strandness R   --sp 2,1      --trim5 1  --trim3 1  --summary-file  $HISAT2_4_g/3.R.$temp.summary    -x $HISAT2_index_g    -U $input_g/$singleEnd_g[$i]        -S $HISAT2_4_g/3.R.$temp.sam     >> $HISAT2_4_g/3.R.$temp.runLog  2>&1");
}
