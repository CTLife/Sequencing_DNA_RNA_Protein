...
my $HELP = '
        ...
        Usage:
               perl xRNA-Seq_2.pl    [-version]    [-help]    [-in inputDir]    [-out outDir]
        For instance:
               nohup time  perl xRNA-Seq_2.pl   -in 1_rawFASTQ   -out 2_removedAdapters    > xRNA-Seq_2.runLog.txt  2>&1    &
...
## Version Infromation
my $version = "    The 2nd Step, version 1.2,  2023-07-25.";
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl xRNA-Seq_2.pl  -help' \n";
    exit 0;
}
