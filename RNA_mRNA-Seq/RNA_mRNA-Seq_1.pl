...
my $HELP = '
        ...
        Usage:
               perl  RNA_mRNA-Seq_1.pl    [-version]    [-help]     [-in inputDir]   
        For instance:
               nohup   time  perl  RNA_mRNA-Seq_1.pl    -in 1_rawFASTQ   > RNA_mRNA-Seq_1.runLog.txt  2>&1  & 
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  RNA_mRNA-Seq_1.pl  -help' \n";
    exit 0;
}
