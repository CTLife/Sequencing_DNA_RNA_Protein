...
my $input_g    = '';  ## such as "4_rawBAM/1_BWA"
my $output_g   = '';  ## such as "5_finalBAM/1_BWA"
...
my $HELP = '
        ...
        Usage:
               perl DNA_ChIP-Seq_5.pl    [-version]    [-help]   [-genome RefGenome]    [-in inputDir]    [-out outDir]   
        For instance:
               nohup  time  perl DNA_ChIP-Seq_5.pl   -genome hg38   -in 4_rawBAM/1_BWA   -out 5_finalBAM/1_BWA       > DNA_ChIP-Seq_5.runLog 2>&1  &  
...
$input_g  = '4_rawBAM/1_BWA';           ## This is only an initialization value or suggesting value, not default value.
$output_g = '5_finalBAM/1_BWA';         ## This is only an initialization value or suggesting value, not default value.
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  DNA_ChIP-Seq_5.pl  -help' \n";
    exit 0;
}
...
if($genome_g eq "hg38"){$BED12_g = "$BED12_g/Gencode/Human_GRCh38.p13/gencode.v43.primary_assembly.annotation.gtf"; }
if($genome_g eq "mm39"){$BED12_g = "$BED12_g/Gencode/Mouse_GRCm39/gencode.vM32.primary_assembly.annotation.gtf"; }
