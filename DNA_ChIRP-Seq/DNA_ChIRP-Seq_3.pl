...
my $HELP = '
        ...
        Usage:
               perl DNA_ChIRP-Seq_3.pl    [-version]    [-help]    [-in inputDir]    [-out outDir]
        For instance:
               nohup  time   perl DNA_ChIRP-Seq_3.pl   -in 2_removedAdapters   -out 3_removedDups    > DNA_ChIRP-Seq_3.runLog.txt  2>&1     &      
...
## Version Infromation
my $version = "    The 3rd Step, version 1.1,  2023-03-05.";
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl DNA_ChIRP-Seq_3.pl  -help' \n";
    exit 0;
}
